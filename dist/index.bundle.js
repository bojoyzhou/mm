...
/***/ function(module, exports, __webpack_require__) {
	...
	var Data = function (_Node) {
	    ...
	    function Data() {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (Data.__proto__ || (0, _getPrototypeOf2.default)(Data)).call(this));
	    ...
	    (0, _createClass3.default)(Data, [{
	        ...
	        key: "parseNode",
	        value: function parseNode(desc, parent) {
	            var _this2 = this;

	            var node = parent.addChild(desc.text);
	            desc.children.forEach(function (d) {
	                _this2.parseNode(d, node);
	            });
	        }
	    }, {
	        key: "parse",
	...
	var Calculator = function () {
	    function Calculator(data, getElem) {
	    ...
	    (0, _createClass3.default)(Calculator, [{
	        key: "calEdge",
	        value: function calEdge() {
	            var _this4 = this;

	            this.data.edges.forEach(function (e) {
	                var abound = _this4.getElem(e.a).getBoundingClientRect(),
	                    bbound = _this4.getElem(e.b).getBoundingClientRect(),
	        ...
	        key: "calNode",
	        value: function calNode() {
	            var _this5 = this;

	            this.data.data.forEach(function (rootNode) {
	                var offset = _this5.balance(rootNode);
	                var t_width = offset.t_width,
	                    t_height = offset.t_height,
	                    t_left = offset.t_left,
	                    t_right = offset.t_right,
	                    t_top = offset.t_top,
	                    t_bottom = offset.t_bottom;
	        ...
	        value: function balance(node) {
	            ...
	            node.children.forEach(function (child) {
	                var _balance = _this6.balance(child),
	                    t_width = _balance.t_width,
	                    t_height = _balance.t_height,
	                    t_left = _balance.t_left,
	                    t_right = _balance.t_right,
	                    t_top = _balance.t_top,
	                    t_bottom = _balance.t_bottom;
	...
	Calculator.width = document.body.offsetWidth;
	...
	var View = function () {
	    ...
	    (0, _createClass3.default)(View, [{
	        ...
	        key: "applyStyle",
	        value: function applyStyle(elem, node) {
	            var left = node.left,
	                top = node.top,
	                text = node.text;
	        ...
	        key: "createPath",
	        value: function createPath(attr) {
	        ...
	        value: function render() {
	            ...
	            this.data.all.forEach(function (node) {
	                if (node.ischanged) {
	                    _this7.applyStyle(_this7.getElem(node), node);
	                    changed = true;
	                }
	            });
	            return changed;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(21)(IteratorPrototype, __webpack_require__(56)('iterator'), function(){ return this; });
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(19)(Function.call, __webpack_require__(74).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
